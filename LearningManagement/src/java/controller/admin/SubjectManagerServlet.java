 ...
 * @author lvhn1
 */
@WebServlet(name="SubjectManagerServlet", urlPatterns={"/admin/subjects"})
public class SubjectManagerServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SubjectManagerServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SubjectManagerServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        int num_of_subjects = db.countSubjects(search);
