 ...
 * @author dell
 */
@WebServlet(name = "ResetPasswordController", urlPatterns = {"/reset-password-byMail"})
public class ResetPasswordController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("reset-password-byMail.jsp").forward(request, response);
    }
...
//            response.sendRedirect("otp-confirmation?action=reset");
