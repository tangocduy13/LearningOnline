 ...
 */
@WebServlet(name = "DownloadAsmController", urlPatterns = {"/download-asm"})
public class DownloadAsmController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName == null || fileName.equals("")) {
            ...
            if (file.exists()) {
                 ...
                 * *** Print The Response ****
                 */
                response.getWriter().println("<h3>File " + fileName + " Is Not Present ...kakak</h3>");
            }
