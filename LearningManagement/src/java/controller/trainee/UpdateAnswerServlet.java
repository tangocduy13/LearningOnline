...
public class UpdateAnswerServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateAnswerServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateAnswerServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (request.getParameter("isChecked").equals("true")) {
            sd.addQuizAnswer(submitId, quesId, ansId);
        } else {
            sd.removeQuizAnswer(submitId, quesId, ansId);
        }
    } 
