                                ...
                                <div class="card border-0 p-4 rounded shadow">
                                    <div class="row align-items-center">
                                        <div class="col-md-8 text-center text-md-start mt-4 mt-sm-0">
                                            <h4 class="">Add new Setting</h4>
                                        </div><!--end col-->
                                    </div><!--end row-->
            
                                    <form class="mt-4" action="add-setting" method="post">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label">Type</label>
                                                    <select name="key" class="form-control department-name select2input">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="title" id="code" type="text" class="form-control" placeholder="Title :" required>
                                                </div>
                                            </div><!--end col-->
