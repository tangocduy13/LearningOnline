                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom p-3" style="min-width: 300px;">Subject code</th>
                                            ...
                                            <c:forEach items="${requestScope.subjects}" var="s" varStatus="loop">
                                                <tr>
                                                    ...
                                                    <td class="text-end p-3">
                                                        <a href="subject-detail-management?id=${s.id}" class="btn btn-icon btn-pills btn-soft-primary">
