                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Subjects Manager</h5>
                            
                            <div class="search-bar p-0 d-none d-lg-block ms-2">
                                <div id="search" class="menu-search mb-0">
                                    <form action="subjects" method="get" id="searchform" class="searchform">
                                        <div>
                            ...
                            <a href="add-subject" class="btn btn-primary">Add New Subject</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.data}" var="s">
                                                <tr>
                                                    ...
                                                    <td class="p-3">${s.manager.name}</td>
                                                    <td class="p-3">
                                                    ...
                                                    <td class="text-end p-3">
                                                        <a href="#"
                                                           ...
                                                           onclick="showSubjectInfo('${s.name}', '${s.code}', '${s.manager.name}', '${s.created_by}', '${s.created_at}', '${s.update_by}', '${s.update_at}')"
                                                        >
                                                            <i class="uil uil-eye"></i>
                                                        </a>
                                                        <a href="edit-subject?id=${s.id}" class="btn btn-icon btn-pills btn-soft-success"><i class="uil uil-pen"></i></a>
