                                ...
                                <div class="card border-0 p-4 rounded shadow">
                                    <div class="row align-items-center">
                                        <div class="col-md-8 text-center text-md-start mt-4 mt-sm-0">
                                            <h4 class="">Edit User #${user.id}</h4>
                                        </div><!--end col-->
                                    </div><!--end row-->
            
                                    <form class="mt-4" action="edit-user?id=${user.id}" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="phone" id="phone" type="tel" class="form-control" placeholder="Phone no. :" value="${user.phone}" oninput="checkEmpty()">
                                                </div> 
                                            </div><!--end col-->
                                        ...
                                        <button type="submit" id="submit-btn" class="btn btn-primary" disabled>Save</button>
                                    </form>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
