                                ...
                                <div class="card border-0 p-4 rounded shadow">
                                    <div class="row align-items-center">
                                        <div class="col-md-8 text-center text-md-start mt-4 mt-sm-0">
                                            <h4 class="">Edit Subject #${subject.id}</h4>
                                        </div><!--end col-->
                                    </div><!--end row-->
            
                                    <form class="mt-4" action="edit-subject?id=${subject.id}" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="manager" class="form-control department-name select2input">
                                                        <c:forEach items="${managers}" var="m">
                                                            <option value="${m.id}" ${subject.manager.id eq m.id ? 'selected' : ''}>${m.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div><!--end col-->
