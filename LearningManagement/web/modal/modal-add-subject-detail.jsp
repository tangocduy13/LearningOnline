...
<div class="modal fade" id="chapterAddModal" tabindex="-1" role="dialog" aria-labelledby="chapterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- N?i dung modal -->
                <form action="subject-detail-management?action=add-chapter" method="post">
                    <input type="hidden" name="subjectId" id="subjectIdadd" value="">
...
<div class="modal" id="dimensionAddModal" tabindex="-1" role="dialog">
    <div class="modal-dialog custom-modal modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="dimensionForm" action="subject-detail-management?action=add-dimension" method="post">
                    <input type="hidden" name="subjectId" id="subjectIdaddx" value="">
